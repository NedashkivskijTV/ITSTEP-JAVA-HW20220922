...
public class Game {
    ...
    private List<QuestionDifficulty> questions = new ArrayList<>();
    ...
    public QuestionDifficulty usePrompt(QuestionDifficulty questionDifficulty) {
        ...
        switch (userChoice) {
            ...
            case "2": {
                ...
                System.out.println("Ваш друг вважає, що правильна відповідь " + answersTemp.get(friendRightAnswer) + "\n");
            ...
            case "3": {
                ...
                List<Question> questionsTemp = DataBase.getQuestion();
                ...
                List<QuestionDifficulty> questionsDifficultyOll = questionsTemp
                        .stream()
                        .map(q -> {
                            QuestionDifficulty questionDifficultyTemp = new QuestionDifficulty(q, Difficulty.values()[countDifficulty[0]]);
                            countDifficulty[0] = (countDifficulty[0] == Difficulty.values().length - 1 ? 0 : countDifficulty[0] + 1);
                            return questionDifficultyTemp;
                        })
    ...
    public void downloadQuestions() {
        ...
        // у разі відсутності достатньої кількості питань (мінімум 2 кожного рівня важкості) підказка -заміна питання- не активується
